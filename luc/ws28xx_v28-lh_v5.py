#!/usr/bin/python
# $Id: ws28xx_v28-lh_v5.py 2357 2014-09-28 12:17:35Z mwall $
#
...
DRIVER_VERSION = '0.28 modified by lh - version 0.5'
...
class CCommunicationService(object):
    ...
    def __init__(self, cache_file):
        ...
        self._a3_offset = 3 # don't settime when offset to whole hour <= _a3_offset
    ...
    def handleHistoryData(self, buf, buflen):
        ...
        if self.command == EAction.aGetHistory:
            ...
            # Save info latest history record
            self.writeLastHistoryIndex(latestIndex,ts)
