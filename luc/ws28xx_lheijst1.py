#!/usr/bin/python
# $Id: ws28xx_lheijst1.py 2357 2014-09-28 12:17:35Z mwall $
#
...
class CCommunicationService(object):
    ...
    def __init__(self, cfgfn):
        ...
        self.Period3 = self.DataStore.getCommModeInterval() + 1 -0.008 # to catch current weather message
        self.durLoop1= 0.620 #0.350 # duration of loop1 
                ...
                try:
                    ...
                    if self.WaitSteps >= 5:
                        ...
                        if self.CpuCorr > 0.0090:
                            self.CpuCorr = 0.0030
                    logerr('WaitSteps %4s, TotalSleepTime %6.3f, TotalLoopTime %6.3f, CpuCorr %7.4f' % (self.WaitSteps, self.TotalSleepTime, TotalLoopTimeSecs, self.CpuCorr))
