#!/usr/bin/python
# $Id: ws28xx-0.9.py 2357 2014-09-28 12:17:35Z mwall $
#
...
#                self.DataStore.setBufferCheck( 2)
    ...
    def handleWsAck(self,Buffer,Length):
        ...
        # FIXME: hack to prevent spurious generateResponse failures
#        Length[0] = 0
        ...
        if Length[0] != 0:
            ...
            if bufferID == 0xF0F0:
                ...
                if responseType == 0x20:
                    ...
                    if Length[0] == 0x06:
                        logdbg('generateResponse: WS SetTime/SetConfig data written')
