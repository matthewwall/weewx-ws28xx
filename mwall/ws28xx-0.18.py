#!/usr/bin/python
# $Id: ws28xx-0.18.py 2357 2014-09-28 12:17:35Z mwall $
#
...
01: rtSetTime    - Ask for SetTime message
02: rtSetConfig  - Ask for SetConfig message
...
40: GetConfig
60: Get Current Weather
80: Get Actual / Outstanding History
...
09lo-11: LatestHistoryIndex [ThisAdr] 2.5 bytes (LatestHistoryAddress is the)
12lo-14: ThisHistoryIndex   [ThisAdr] 2.5 bytes (same as ThisHistoryAddress)
